...
#    Updated: 2019/05/28 13:52:31 by vmabuza          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_abs.c ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	  ft_isblank.c ft_isdigit.c ft_islower.c ft_isnumber.c ft_isprint.c \
	  ft_isspace.c ft_isupper.c ft_isxdigit.c ft_itoa.c ft_lstadd.c \
	  ...
	  ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlen.c ft_intlen.c \
